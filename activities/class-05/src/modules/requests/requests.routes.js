// ============================================================================
// HTTP layer of the requests module. Every handler passes req.auth as the
// first argument to the service — the middleware has already verified the
// token and built the only trusted identity.
// ============================================================================
